...
#python main.py --model EDSR --scale 2 --save EDSR_baseline_x2 --reset --ext bin
...
#python main.py --model EDSR --scale 4 --pre_train ../experiment/model/EDSR_baseline_x4.pt --reset --test_only --n_val 100 --save_results
