...
python main.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset --dir_data ../data/
...
# python main.py --model EDSR --scale 3 --patch_size 144 --save edsr_baseline_x3 --reset --pre_train ../experiment/model/edsr_baseline_x2
...
# Test your own images (cpu)
# python main.py --data_test Demo --scale 4 --pre_train download --test_only --save_results --pre_train ../experiment/model/edsr_baseline_x4.pt
